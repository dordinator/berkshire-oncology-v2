...
Source: `docs/a11y/2026-09-05-verified.json`
...
| `/locations` | `.body-lg.max-w-xl.mt-6` | 3.05:1 on #fafbfc | 6.88:1 on #fafbfc | 18px |
| `/locations` | `.body-lg.max-w-xl.mt-5` | 3.05:1 on #fafbfc | 6.88:1 on #fafbfc | 18px |
| `/locations` | `.gap-2\.5` | 3.83:1 on #fafbfc | 6.88:1 on #fafbfc | 12px |
| `/locations` | `.border-b` | 2.75:1 on #fafbfc | 6.88:1 on #fafbfc | 12px |
| `/locations` | `.grid-cols-\[6\.5rem_minmax\(0\,1fr\)\].gap-4.grid:nth-` | 4.49:1 on #fafbfc | 16.06:1 on #fafbfc | 18px |
| `/locations` | `.grid-cols-\[6\.5rem_minmax\(0\,1fr\)\].gap-4.grid:nth-` | 3.09:1 on #fafbfc | 8.10:1 on #fafbfc | 14px |
| `/locations` | `.grid-cols-\[6\.5rem_minmax\(0\,1fr\)\].gap-4.grid:nth-` | 3.09:1 on #fafbfc | 8.10:1 on #fafbfc | 14px |
