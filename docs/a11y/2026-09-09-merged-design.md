...
- **/patients** `.bg-sage-mist > .flex-col.flex-1.min-w-0 > .mt-12.md\:mt-auto.md\:pt-12 > .gap-8.border-ink\/15.md\:grid-cols-\[minmax\(0\,1fr\)_auto\] > ul > .type-body.text-ink\/75:nth-child(3) > span:nth-child(2)` — 320/375/768px, default motion
  - Fix any of the following: Element has insufficient color contrast of 2.09 (foreground color: #a2abb9, background color: #f2f4f3, font size: 11.3pt (15px), font weight: normal). Expected contrast ratio of 4.5:1
- **/patients** `.hover\:border-ink\/40.hover\:bg-white\/30[href$="specialities"]` — 320/375/768/1024/1440px, default motion
...
- **/patients** `article[aria-labelledby="second-opinion-title"] > .flex-col.flex-1.min-w-0 > .mt-12.md\:mt-auto.md\:pt-12 > .gap-8.border-ink\/15.md\:grid-cols-\[minmax\(0\,1fr\)_auto\] > ul > .type-body.text-ink\/75:nth-child(3) > span:nth-child(2)` — 320/375/768px, default motion
  - Fix any of the following: Element has insufficient color contrast of 2.1 (foreground color: #a3acbd, background color: #f3f6f9, font size: 11.3pt (15px), font weight: normal). Expected contrast ratio of 4.5:1
- **/patients** `.hover\:border-ink\/40.hover\:bg-white\/30[href$="contact"]` — 320/375/768/1024/1440px, default motion
...
- **/patients** `article[aria-labelledby="private-treatment-title"] > .flex-col.flex-1.min-w-0 > .mt-12.md\:mt-auto.md\:pt-12 > .gap-8.border-ink\/15.md\:grid-cols-\[minmax\(0\,1fr\)_auto\] > ul > .type-body.text-ink\/75:nth-child(3) > span:nth-child(2)` — 320/375px, default motion
  - Fix any of the following: Element has insufficient color contrast of 2.11 (foreground color: #a6acb8, background color: #f8f6f2, font size: 11.3pt (15px), font weight: normal). Expected contrast ratio of 4.5:1
- **/patients** `.hover\:border-ink\/40.hover\:bg-white\/30[href$="tariffs"]` — 320/375/768/1024/1440px, default motion
...
- **/patients** `article[aria-labelledby="receiving-treatment-title"] > .flex-col.flex-1.min-w-0 > .mt-12.md\:mt-auto.md\:pt-12 > .gap-8.border-ink\/15.md\:grid-cols-\[minmax\(0\,1fr\)_auto\] > ul > .type-body.text-ink\/75:nth-child(3) > span:nth-child(2)` — 320/375px, default motion
  - Fix any of the following: Element has insufficient color contrast of 2.1 (foreground color: #a3acbd, background color: #f3f6f9, font size: 11.3pt (15px), font weight: normal). Expected contrast ratio of 4.5:1
- **/patients** `article[aria-labelledby="receiving-treatment-title"] > .flex-col.flex-1.min-w-0 > .mt-12.md\:mt-auto.md\:pt-12 > .gap-8.border-ink\/15.md\:grid-cols-\[minmax\(0\,1fr\)_auto\] > .hover\:border-ink\/40.hover\:bg-white\/30.focus-visible\:border-ink\/40` — 320/375/768/1024/1440px, default motion
  - Fix any of the following: Element has insufficient color contrast of 2.82 (foreground color: #8894a8, background color: #f3f6f9, font size: 10.5pt (14px), font weight: normal). Expected contrast ratio of 4.5:1
...
- **/patients** `article[aria-labelledby="supporting-someone-title"] > .flex-col.flex-1.min-w-0 > .mt-12.md\:mt-auto.md\:pt-12 > .gap-8.border-ink\/15.md\:grid-cols-\[minmax\(0\,1fr\)_auto\] > ul > .type-body.text-ink\/75:nth-child(3) > span:nth-child(2)` — 320/375/768px, default motion
  - Fix any of the following: Element has insufficient color contrast of 2.07 (foreground color: #9ca5b2, background color: #e8ebe9, font size: 11.3pt (15px), font weight: normal). Expected contrast ratio of 4.5:1
- **/patients** `article[aria-labelledby="supporting-someone-title"] > .flex-col.flex-1.min-w-0 > .mt-12.md\:mt-auto.md\:pt-12 > .gap-8.border-ink\/15.md\:grid-cols-\[minmax\(0\,1fr\)_auto\] > .hover\:border-ink\/40.hover\:bg-white\/30.focus-visible\:border-ink\/40` — 320/375/768/1024/1440px, default motion
...
- **/locations** `.gap-2\.5` — 1440px, default motion
  - Fix any of the following: Element has insufficient color contrast of 3.81 (foreground color: #788093, background color: #fafbfc, font size: 9.0pt (12px), font weight: normal). Expected contrast ratio of 4.5:1
