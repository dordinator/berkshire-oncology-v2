...
- `span` hides 119px horizontal — "Berkshire Oncology Partnership"
- `span` hides 6px horizontal — "Spire Dunedin"
- `span` hides 16px horizontal — "Royal Berkshire"
- `span` hides 34px horizontal — "Princess Margaret"
- `span` hides 55px horizontal — "GenesisCare Windsor"
