...
## Contact panel alignment — 10 September 2026

The contact panel now distributes its existing vertical space equally above and below its content. At 1600px this gives 64px on each side instead of 96px above and 32px below. Its outer height remains 529px. Panel width and height also remain unchanged at the checked 1440, 768, 375 and 320px widths.
