    ...
    <>
      ...
      >
        <div
          ...
          className="max-h-[calc(100svh_-_9rem)] w-full overflow-y-auto overscroll-contain rounded-b-panel border border-t-0 border-black/[0.06] bg-white/95 px-4 pb-[max(1.25rem,env(safe-area-inset-bottom))] pt-3 shadow-[0_28px_80px_-24px_rgba(6,28,70,0.28)] backdrop-blur-xl sm:px-6"
        >
