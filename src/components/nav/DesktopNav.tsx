      ...
      >
        <div ref={measureRef}>
          <motion.div
            ...
            className="max-h-[calc(100svh-8rem)] w-full overflow-y-auto rounded-b-panel border border-t-0 border-black/[0.06] bg-white/95 px-7 pb-7 pt-5 shadow-[0_28px_80px_-24px_rgba(6,28,70,0.28)] backdrop-blur-xl"
            data-lenis-prevent
