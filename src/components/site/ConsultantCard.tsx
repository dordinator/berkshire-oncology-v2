...
export default function ConsultantCard({
  ...
  return (
    ...
    >
      <div className="relative aspect-[4/5] w-full overflow-hidden bg-gradient-to-br from-accent/10 to-lilac/20">
        {consultant.photo ? (
          <Image
      ...
      <div className="flex flex-1 flex-col p-6">
        <h3 className="font-display text-xl text-ink">{consultant.name}</h3>
        <p className="mt-1 text-sm text-ink-muted">{consultant.role}</p>
        {pills.length > 0 && (
